	...
	try
		{
			if(!isset($errorMsg))
			{
				$insert_stmt=$db->prepare('INSERT INTO Collection_p(Nom) VALUES(:Nom)'); //sql insert query					
				...
				if($insert_stmt->execute())
				{
					...
					header("Location:COLLECTION.php"); //refresh 1 second and redirect to index.php page
				}
			}
		}
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" style=" margin-top: 30px;">
				...
				<a href="CATEGORIES.php" class="btn btn-danger">Annuler</a>
				</div>
				</div>

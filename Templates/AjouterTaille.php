	...
	try
		{
			if(!isset($errorMsg))
			{
				$insert_stmt=$db->prepare('INSERT INTO Taille(Nom) VALUES(:Nom)'); //sql insert query					
				...
				if($insert_stmt->execute())
				{
					...
					header("Location:TAILLES.php"); //refresh 1 second and redirect to index.php page
				}
			}
		}
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" style=" margin-top: 30px;">
				...
				<a href="TAILLES.php" class="btn btn-danger">Annuler</a>
				</div>
				</div>

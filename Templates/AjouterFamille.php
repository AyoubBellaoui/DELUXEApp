	...
	try
		{
			if(!isset($errorMsg))
			{
				$insert_stmt=$db->prepare('INSERT INTO base_famille(Nom) VALUES(:Nom)'); //sql insert query					
				...
				if($insert_stmt->execute())
				{
					...
					header("Location:FAMILLES.php"); //refresh 1 second and redirect to index.php page
				}
			}
		}
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal" style=" margin-top: 30px;">
				...
				<a href="FAMILLES.php" class="btn btn-danger">Annuler</a>
				</div>
				</div>

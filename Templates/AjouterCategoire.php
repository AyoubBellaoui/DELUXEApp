	...
	try
		{
			if(!isset($errorMsg))
			{
				$insert_stmt=$db->prepare('INSERT INTO Categorie(Nom) VALUES(:Nom)'); //sql insert query					
				...
				if($insert_stmt->execute())
				{
					...
					header("Location:CATEGORIES.php"); //refresh 1 second and redirect to index.php page
				}
			}
		}
